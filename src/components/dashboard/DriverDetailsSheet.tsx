...
export function DriverDetailsSheet({
  ...
  return (
    <>
      ...
      />
      <aside
        className="fixed right-0 top-10 z-[120] flex h-[calc(100vh-2.5rem)] w-full max-w-md flex-col border-l border-white/10 bg-[#16181A] shadow-[-12px_0_48px_-12px_rgba(0,0,0,0.65)]"
        role="dialog"
        aria-modal="true"
